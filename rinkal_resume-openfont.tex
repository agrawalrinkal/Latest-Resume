...
\section{Projects}
\runsubsection{Spy}
\descript{| A web app for monitoring team's success} 
\location{Independent project, 5 weeks  \hfill | Angular6, Java}
\begin{tightemize}
...
\runsubsection{Router Model}
\descript{| DL model to predict router failure} 
\location{Personal work project, 6 weeks  \hfill | Python, PyTorch}
\begin{tightemize}
...
\descript{| A Web app for hearing impaired students} 
\location{Non-Academic Project, 4 months, team of 4  \hfill | React}
\begin{tightemize}
...
\descript{| An iOS app for tracking bitcoin prices} 
...
\location{Academic Project, 4 months, team of 2 \hfill  | C++}
\begin{tightemize}
